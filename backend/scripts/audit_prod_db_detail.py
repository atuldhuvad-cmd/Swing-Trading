"""Detailed audit of production DB records that look suspicious."""
import sqlite3
import os
...
print('\n=== IMPORT BATCHES ===')
cur.execute('SELECT batch_id, filename, import_date, status, total_rows, accepted_rows FROM import_batch')
